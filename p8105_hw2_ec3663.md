...
mr_trash_wheel_df =
  read_excel("data/trash_wheel_collection_data.xlsx", sheet = 1, range = "A2:N550") |> 
  mutate()
```
...
``` r
prof_trash_wheel_df =
  read_excel("data/trash_wheel_collection_data.xlsx", sheet = 2, range = "A2:M96")
```
...
``` r
gwynnda_df =
  read_excel("data/trash_wheel_collection_data.xlsx", sheet = 3, range = "A2:K110")
```
